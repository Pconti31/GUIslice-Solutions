...
enum {E_BTN_QUIT,E_ELEM_IMAGE1,E_ELEM_PROGRESS1,E_ELEM_TEXT1
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemXProgressCreate(&m_gui,E_ELEM_PROGRESS1,E_PG_POPUP1,&m_sXBarGauge1,
    (gslc_tsRect){60,165,200,12},0,100,0,GSLC_COL_GREEN,false);
  m_pElemProgress1 = pElemRef;
  
  // Create E_ELEM_TEXT3 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT3,E_PG_POPUP1,(gslc_tsRect){138,190,43,10},
    (char*)"Loading",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
//<InitGUI !End!>
