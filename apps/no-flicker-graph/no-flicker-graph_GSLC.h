...
//<Enum !Start!>
enum {E_PG_MAIN};
enum {E_ELEM_BTN_STATE,E_ELEM_GRAPH1,E_ELEM_TEXT3};
...
int16_t                         m_anGraphBuf1[300]; // NRows=300
...
extern gslc_tsElemRef* m_pElemBtnState;
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemXGraphCreate(&m_gui,E_ELEM_GRAPH1,E_PG_MAIN,
    &m_sGraph1,(gslc_tsRect){9,40,302,200},E_BUILTIN5X8,(int16_t*)&m_anGraphBuf1,
        300,GSLC_COL_GREEN);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT3,E_PG_MAIN,(gslc_tsRect){15,10,217,18},
    (char*)"Graph SIN Function",0,E_BUILTIN10X16);
  
  // Create E_ELEM_BTN_STATE button with modifiable text label
  static char m_strbtn1[6] = "PAUSE";
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN_STATE,E_PG_MAIN,
    (gslc_tsRect){245,10,60,20},
    (char*)m_strbtn1,6,E_BUILTIN5X8,&CbBtnCommon);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BLUE_DK2,GSLC_COL_RED,GSLC_COL_GRAY);
  m_pElemBtnState = pElemRef;
//<InitGUI !End!>
